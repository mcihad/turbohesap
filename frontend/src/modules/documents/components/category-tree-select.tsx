// CategoryTreeSelect — pick an evrak category from the tree. Mirrors
// `inventory/components/category-tree-select.tsx`: a single Select with
// depth-based indentation, so the hierarchy is visible while staying a familiar
// dropdown.
...
function flatten(cats: DocumentCategoryDto[]): Flat[] {
