// DynamicAttributeFields (mobile) — renders a category's custom field definitions
// as live inputs bound to a product's `attributes` bag. The RN twin of the web
// component; used by the product form once a category is chosen.

import * as React from 'react'
import { View } from 'react-native'

import type { CategoryFieldDef, SourcedFieldDef } from '@turbohesap/shared'
