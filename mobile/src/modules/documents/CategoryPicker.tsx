// CategoryPicker (documents) — a modal category selector with depth
// indentation, the evrak twin of inventory's CategoryPicker. Read-only tree
// selection only; creating/editing categories is a desk-only task on mobile.
