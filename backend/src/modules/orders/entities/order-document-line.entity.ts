...
// Order document line. Per-line computed values are persisted (shared invoice
// helpers), so order line totals match the invoice they convert into.
@Entity('order_document_lines')
export class OrderDocumentLine extends BaseEntity {
  @Index()
  @Column({ type: 'uuid' })
  documentId!: string
